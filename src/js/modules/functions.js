...
$(document).ready(function () {
    ...
    $('.arrow-btn__circle-left').mouseenter(function (e) {
        if (Number(window.innerWidth) <= 660) {
            $(this).parent().find('.arrow-btn__circle-right').css('transform', 'translateX(100px)');
        }
    }).mouseleave(function (e) {
        if (Number(window.innerWidth) <= 660) {
            $(this).parent().find('.arrow-btn__circle-right').css('transform', 'translateX(0)');
        }
    })

    $('.arrow-btn__circle-left').on('click', function (e) {
        $(this).parent().find('.arrow-btn__circle-right').removeClass('active');
        $(this).addClass('active');
        if (Number(window.innerWidth) <= 660) {
            $(this).parent().find('.arrow-btn__circle-right').addClass('tr100');
        }
    })
    $('.arrow-btn__circle-right').on('click', function (e) {
        $(this).parent().find('.arrow-btn__circle-left').removeClass('active');
        $(this).addClass('active');
        if (Number(window.innerWidth) <= 660) {
            $(this).removeClass('tr100');
        }
    })
    // ------------------------------------------------------------
